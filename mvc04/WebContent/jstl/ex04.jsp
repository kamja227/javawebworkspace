...
<body>
	...
	<%
		...
		java.util.ArrayList<com.bit.model.JavaBean> beans = new java.util.ArrayList<com.bit.model.JavaBean>();
		com.bit.model.JavaBean bean = new com.bit.model.JavaBean();
		bean.setSu1(1234);
		bean.setSu2(3.14);
		bean.setName("abcd");
		beans.add(bean);
	...
	%>
	<!--forEach를 사용하여 향상된 for문처럼 활용할 수 있다. -->
	<ol>
